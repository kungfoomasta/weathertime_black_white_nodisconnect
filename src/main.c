...
#define MY_UUID { 0x91, 0x41, 0xB6, 0x28, 0xBC, 0x89, 0x49, 0x8E, 0xB1, 0x47, 0x04, 0x9F, 0x49, 0xC0, 0x99, 0xAE }

PBL_APP_INFO(MY_UUID,
             "Weather/Time BW", "Kevin O'Connor", // mod of futura weather by niknam moslehi which is a modification of "Roboto Weather" by Martin Rosinski
             1, 1, /* App version */
...
void success(int32_t cookie, int http_status, DictionaryIterator* received, void* context) {
	...
	if(icon_tuple) {
		...
		if(icon >= 0 && icon < 10) {
			...
			weather_layer_set_icon(&weather_layer, WEATHER_KEY_ICON);
		}
	}
